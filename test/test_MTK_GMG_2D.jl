...
@test sum(Arrays.Tnew)/prod(size(Arrays.Tnew)) ≈ 303.30366601026446  rtol= 1e-2
@test sum(time_props.MeltFraction)  ≈ 0.037938081339082066  rtol= 1e-5
...
@test sum(time_props.MeltFraction)  ≈ 0.9410554343236748 rtol= 1e-5
