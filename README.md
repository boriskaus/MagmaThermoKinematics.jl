...
Num                     =   Numeric_params(verbose=false)                   # Nonlinear solver option
...
nTr_dike                =   300;                        # number of tracers inserted per dik
...
else        Phases      =   ones(Int64,Grid.N...)   en
...
for it = 1:nt   # Time loo
    ...
    en
    Nonlinear_Diffusion_step_2D!(Arrays, MatParam, Phases, Grid, dt, Num)   # Perform a nonlinear diffusion ste
